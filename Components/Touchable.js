...
export default class Touchable extends React.Component {
    ...
    render() {
        ...
        // Even though it works for TouchableWithoutFeedback and TouchableNativeFeedback with this component, we want
        // the API to be the same for all components so we require  exactly one direct child for every touchable type.
